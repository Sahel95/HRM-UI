        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">اضافه کردن کمپین {{item.name}}
                    ...
                    <div class="panel panel-success">
                       ...
                       <div class="panel-footer">
                         <div class="row text-left">
                          <div class="col-md-12">
                           <button class="btn btn-success" @click="addCampaign()">اضافه کردن</button>
                         </div>
                        </div>
                       </div>
                     </div>
  ...
  data() {
    ...
    methods:{
      addCampaign: function(){
        ...
        this.$http.post(this.baseUrl + '/api/game/campaign/add' , {'name': this.item.name , 'description': this.item.description }).then(function(data) {
            $('#message').html("<div class='alert alert-success'>عملیات با موفقیت انجام شد</div>");
            window.location.href="/game/camp/edit/" + data.body.item
